...
class ButtonPressAnalysis:
    ...
    def __init__(cls):
        ...
        cls.pathAmpRise_perSec  = Path( "data\\preTest\\listFirstHalf_listSecondHalf\\participant%d_preTest%d.txt" %(participantNr, preTest_trial) )
        cls.samplerate          = 500
...
ButtonPressAnalysis()
print(ButtonPressAnalysis.resultDict) # scheint zu funzen